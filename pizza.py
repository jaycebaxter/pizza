...
# Setting the value for pi as a constant so I don't have to type it every time
...
# Diameter between 8 and <12 = 6 slices
    if float(diameter) >= 8 and float(diameter) < 12:
        print(f"A {diameter} inch pizza can be cut into 6 slices. Each slice would be {slices_6} inches.")
        break
